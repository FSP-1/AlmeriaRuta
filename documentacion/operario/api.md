...
## Visión general
La API de operario está diseñada para que el frontend pueda consultar información operativa y ejecutar acciones de control sobre el servicio. A nivel funcional, cubre tres áreas: avisos, estado de paradas y control de permisos por rol.
...
La lectura de avisos puede ser abierta para mejorar accesibilidad al usuario final, pero toda acción que modifica estado debe exigir token válido y rol operario. No basta con validar que existe token; debe validarse también su autorización funcional.
